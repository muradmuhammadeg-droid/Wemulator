...
function findWasmBinary() {
  return locateFile('wii_engine.wasm');
}
...
var _initWiiSystem = Module['_initWiiSystem'] = makeInvalidEarlyAccess('_initWiiSystem');
var _loadWiiMenuWad = Module['_loadWiiMenuWad'] = makeInvalidEarlyAccess('_loadWiiMenuWad');
var _getVramAddress = Module['_getVramAddress'] = makeInvalidEarlyAccess('_getVramAddress');
var _stepGPUFrame = Module['_stepGPUFrame'] = makeInvalidEarlyAccess('_stepGPUFrame');
var _stepWiiCPUCycles = Module['_stepWiiCPUCycles'] = makeInvalidEarlyAccess('_stepWiiCPUCycles');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['initWiiSystem'] != 'undefined', 'missing Wasm export: initWiiSystem');
  assert(typeof wasmExports['loadWiiMenuWad'] != 'undefined', 'missing Wasm export: loadWiiMenuWad');
  assert(typeof wasmExports['getVramAddress'] != 'undefined', 'missing Wasm export: getVramAddress');
  assert(typeof wasmExports['stepGPUFrame'] != 'undefined', 'missing Wasm export: stepGPUFrame');
  assert(typeof wasmExports['stepWiiCPUCycles'] != 'undefined', 'missing Wasm export: stepWiiCPUCycles');
  ...
  _initWiiSystem = Module['_initWiiSystem'] = createExportWrapper('initWiiSystem', wasmExports['initWiiSystem'], 2);
  _loadWiiMenuWad = Module['_loadWiiMenuWad'] = createExportWrapper('loadWiiMenuWad', wasmExports['loadWiiMenuWad'], 2);
  _getVramAddress = Module['_getVramAddress'] = createExportWrapper('getVramAddress', wasmExports['getVramAddress'], 0);
  _stepGPUFrame = Module['_stepGPUFrame'] = createExportWrapper('stepGPUFrame', wasmExports['stepGPUFrame'], 1);
  _stepWiiCPUCycles = Module['_stepWiiCPUCycles'] = createExportWrapper('stepWiiCPUCycles', wasmExports['stepWiiCPUCycles'], 1);
